...
<?php include("file:///C:/wamp/www/AdminLTE-master/custom/include/head.php"); ?>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <?php include("file:///C:/wamp/www/AdminLTE-master/custom/include/header.php"); ?>

                <?php include("file:///C:/wamp/www/AdminLTE-master/custom/include/main-sidebar.php"); ?>
                                        ...
                                        <div class="box-body">
                                            <ul class="products-list product-list-in-box">
                                                <li class="item">
                                                    ...
                                                    <div class="product-info">
                                                        <p class="product-title">Nom</p>
                                                        <span class="product-description">Pierre Truchot</span>
                                                    </div>
                                                </li>
                                                <!-- /.item -->
                                                <li class="item">
                                                    <div class="product-info">
                                                        <p class="product-title">Nombre de crédit formation</p>
                                                        <span class="product-description">150</span>
                                                    </div>
                                                </li>
                                                <!-- /.item -->
                                                <li class="item">
                                                    <div class="product-info">
                                                        <p class="product-title">Nombre de jour restant</p>
                                                        <span class="product-description">2</span>
                                                    </div>
                                                </li>
                                                <!-- /.item -->
                    ...
                    <?php include("file:///C:/wamp/www/AdminLTE-master/custom/include/footer.php"); ?>
